...
def create_app(test_config=None):
    ...
    def create_question():
        ...
        #send back "bad request" if te client wants to create new question with any empty parameter
    ...
    def play_quiz():
        ...
        #choose question from quiz category
        else:
            questions = Question.query.order_by(Question.id).filter(Question.category == quiz_category_id).all()
