...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_404_sent_when_requesting_beyond_valid_page(self):
    ...
    def test_400_if_question_creation_fails_due_to_bad_request_data(self):
    ...
    def test_get_questions_with_search_results(self):
    ...
    def test_get_questions_with_no_search_results(self):
    ...
    def test_if_no_questions_in_current_category(self):
        res = self.client().get('/categories/1/questions')
        data = json.loads(res.data)
    ...
    def test_400_if_play_quiz_request_body_is_bad(self):
    ...
    def test_405_method_not_allowed(self):
        res = self.client().patch('/quizzes', json={'quiz_category':{'id':'1', 'type':'science'},'previous_questions':[]})
        data = json.loads(res.data)
